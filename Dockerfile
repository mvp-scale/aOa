...
directory=/app/index
environment=REPOS_ROOT="/repos",CONFIG_DIR="/config",INDEXES_DIR="/indexes",CLAUDE_SESSIONS="/claude-sessions",REDIS_URL="redis://localhost:6379/0",PORT="9999",USER_HOME="%(ENV_USER_HOME)s",AOA_CONTENT_CACHE_MB="%(ENV_AOA_CONTENT_CACHE_MB)s"
autostart=true
autorestart=true
